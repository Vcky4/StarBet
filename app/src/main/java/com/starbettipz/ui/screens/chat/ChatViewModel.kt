package com.starbettipz.ui.screens.chat
...
import com.starbettipz.data.db.models.ChatModel
import com.starbettipz.data.db.models.ConversationModel
import com.starbettipz.datastore.Settings
import com.starbettipz.datastore.SettingsConstants
...
class ChatViewModel(private val context: Application) : ViewModel(), KoinComponent {
    ...
    private val serverKey =
        "key=" + "AAAA61ATHu4:APA91bFHapdUNCXqVD-oMYnNN9rEAcCeF9POyr2AmwUPTwFXphLlMHAlhL7Yh71GGaK2-uXPuzvKHmS_CbUel-XXH1eigeOZ8YD7gMTP8cy0NQmBO1y7qZvfQObr4jtD8-FNA7qlDukR"
